    ...
    function generateBlogPostCard($id, $category, $title, $description, $author, $date, $postImage = './assets/images/placeholder.png', $avatarImage = './assets/images/placeholder.png') {
        return '
            <a class="blog-post-card" href="/post/'.htmlspecialchars($id, ENT_QUOTES, 'UTF-8').'">
                ...
                <img src="'.htmlspecialchars($postImage, ENT_QUOTES, 'UTF-8').'" alt="Blog post image" class="blog-post-card__image">
                <!-- Post details -->
                ...
                <div class="blog-post-card__info">
                    <img src="'.htmlspecialchars($avatarImage, ENT_QUOTES, 'UTF-8').'" alt="Blog post image" class="blog-post-card__avatar">
                    <div>
