    ...
    <div class="container">
        ...
        <form id="login-form" class="auth-form" action="" method="POST">
            ...
            <div class="auth-form__group <?php echo $model->hasError('password') ? 'is-invalid' : '' ?>">
                ...
                <input type="password" id="password-input" name="password" autocomplete="password" class="input" placeholder="Password" value="<?php echo htmlspecialchars($model->password);?>">
