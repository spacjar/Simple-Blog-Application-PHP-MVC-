...
<head>
    ...
    <title>Příspěvek - Blog - Jaroslav Špác</title>
...
<body>
    ...
    <main class="blog-detail">
        <div class="blog-detail-header">
            <div class="container">
                <h1 class="heading-1">Blog title heading will go here</h1>
            </div>
        </div>
        <!-- <div class="blog-detail-information">
            <div class="container">
                <div class="blog-detail-information__info">
                    <img src="./assets/placeholder.png" alt="Blog post image" class="blog-detail-information__avatar">
                    <div>
